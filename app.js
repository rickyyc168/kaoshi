...
const PRODUCTS = {
  cet: [
    { id: 'einstein-en', emoji: '🧠', name: '爱因斯坦的脑子・英语加强版', desc: '通用智商 +1000，四六级阅读秒懂，听力全对，写作直接出满分范文', price: 0.5, tags: ['全网爆款', '自带流量'], iq: 1000, hot: true },
  ...
  finals: [
    { id: 'gauss', emoji: '📐', name: '高斯的脑子・数学王子版', desc: '通用智商 +1000，高数/线代/概率论秒解，计算题全对', price: 0.06, tags: ['数学之神', '理工刚需'], iq: 1000, hot: true },
    ...
    { id: 'weidongyi', emoji: '🏆', name: '韦东奕的数学脑', desc: '北大韦神专属，高数难题直接秒，期末满绩不是梦', price: 1.99, tags: ['当代网红', '自带流量'], iq: 1500, hot: true }
  ],
  thesis: [
    ...
    { id: 'qianxuesen', emoji: '🚀', name: '钱学森的学术脑', desc: '跨学科科研 buff，论文深度拉满，答辩直接封神', price: 2.99, tags: ['高端款', '硕博专属'], iq: 2500, hot: true },
